...
&& in_array($extension, $allowedExts))
  ...
  if ($_FILES["file"]["error"] > 0)
    ...
    if (file_exists("../pg/" . $_FILES["file"]["name"]))
	  ...
	  $Pisactive = $_POST['EvIsActive'];
	$nlname =  $_POST['txtNlName'];
	
		$sql = "INSERT INTO newsletter".
			   "(filename,IsActive, AddDate, AddUserId,Name, StreamId) ".
			   "VALUES('".$_FILES["file"]["name"]."',".$Pisactive.", NOW(), ".$_SESSION['uid'].",'".$nlname."',".$_SESSION['StreamId'].")";
		echo $sql . "<br />";
		...
		header("Location: subnewsletter.php");
      }
    }
  }
else
